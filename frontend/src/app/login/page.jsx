  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-slate-950 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        <div className="mx-auto w-12 h-12 rounded-2xl bg-gradient-to-br from-indigo-600 to-slate-900 text-white flex items-center justify-center shadow-lg shadow-indigo-500/20 mb-4">
          <Sparkles className="w-6 h-6" />
        </div>
        <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white">
          smart<span className="text-indigo-600 dark:text-indigo-400">Task</span>
        </h2>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white dark:bg-slate-900 py-8 px-6 sm:px-10 shadow-[0_4px_20px_rgba(0,0,0,0.03)] rounded-3xl border border-slate-100 dark:border-slate-800 animate-fade-in">
          {/* Tab Selector */}
          <div className="grid grid-cols-2 p-1 bg-slate-100 dark:bg-slate-800 rounded-xl mb-6 border border-slate-200/60 dark:border-slate-700">
            <button
              type="button"
              onClick={() => {
                setActiveTab('select');
          ...
          {errorMessage && (
            <div className="mb-5 p-3.5 bg-red-50/90 dark:bg-red-950/40 border border-red-200 dark:border-red-900/50 rounded-xl flex items-start gap-2.5 text-xs text-red-700 dark:text-red-400 animate-slide-up">
          ...
          {successMessage && (
            <div className="mb-5 p-3.5 bg-emerald-50/90 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-900/50 rounded-xl flex items-start gap-2.5 text-xs text-emerald-700 dark:text-emerald-400 animate-slide-up">
            ...
            <form onSubmit={handleSelectLogin} className="space-y-4">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-700 shadow-xs hover:shadow-md transition-all duration-150 active:scale-98 disabled:opacity-60"
                >
                  {submitting ? (
